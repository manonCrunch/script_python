...
EMPLACEMENT_SAUVEGARDE = sys.argv[1]
DOSSIER_DE_SAUVEGARDE = sys.argv[2]
EMPLACEMENT = os.path.join(EMPLACEMENT_SAUVEGARDE, DOSSIER_DE_SAUVEGARDE)


chdir(EMPLACEMENT_SAUVEGARDE)

try:
  os.mkdir(DOSSIER_DE_SAUVEGARDE)
except OSError:
	pass 
